...
1. Run Playwright locally to generate new artifacts (example):
...
1. Inspect generated artifacts under `frontend/reports/playwright-report/` and `frontend/reports/test-results/`.
