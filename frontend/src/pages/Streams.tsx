...
import { useCreateStream, useStreamCategories, useStreams } from '@/hooks/useStreams'
...
function GoLiveModal() {
    ...
    const [streamType, setStreamType] = useState<'youtube' | 'twitch' | 'hls' | 'iframe'>('youtube')
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[500px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Set up your stream details. You can use YouTube, Twitch, or a custom HLS
                        URL.
                    </DialogDescription>
                </DialogHeader>
            ...
            <div className="max-w-7xl mx-auto p-6">
                ...
                {isLoading ? (
                    ...
                    <div className="text-center py-20">
                        ...
                        <h3 className="text-xl font-semibold mb-2">No streams live right now</h3>
